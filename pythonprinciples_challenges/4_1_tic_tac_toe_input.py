...
# to a tuple (row, column). Name your function get_row_col; it should
#  take a single parameter which is a string of length 2 consisting of an uppercase letter and a digit.
...
def get_row_col(position):
    ...
    return (int(position[1]) - 1,dictPos[str(position[0])] )
